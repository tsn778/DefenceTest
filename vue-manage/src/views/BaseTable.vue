<template>
 ...
 -->
		...
		<el-dialog title="编辑" v-model="editVisible" width="40%">
			<h2 style="margin-left: 20px;margin-bottom: 20px;">添加学生</h2>
			<el-form ref="form" :model="student" label-width="70px">
				...
				<el-form-item label="毕业年级">
										<el-col :span="10">
											<el-date-picker  type="year" placeholder="选择年级" 
				v-model="student.gradeYear" style="width: 100%;">
											</el-date-picker>
										</el-col>
									</el-form-item>
	...
	export default {
		...
		methods: {
			...
			handlePageChange(val) {
				const _this = this;
				GetUserList({gradeYear:''},val, this.pageSize).then(function(res) {
					console.log(res);
			...
			getAllData() {
				const _this = this;
				GetUserList({gradeYear:''},1, 1000).then(function(res) {
					console.log(res);
		...
		created() {
			...
			const _this = this;
			GetUserList({gradeYear:''},1, this.pageSize).then(function(res) {
				console.log(res);
				_this.tableData = res.data.records;
				_this.total = res.data.total;
